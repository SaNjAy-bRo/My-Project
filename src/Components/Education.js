        ...
        <section  className="py-16 bg-gray-100">
            <div className="container mx-auto">
                <div className="mb-20 text-center">
                    ...
                    <h1 id="education" className="mb-4 text-3xl font-medium text-gray-800 sm:text-4xl title-font">
                        Education
                    </h1>
                    <p className="mx-auto text-base leading-relaxed xl:w-2/4 lg:w-3/4">
                        Explore my academic journey and accomplishments in the field ofnpm 
                        Computer Science.
                    </p>
                </div>
